# -*- coding: utf-8 -*-
"""This is a the main class for the SIA UDP Client."""
import asyncio
import logging
import socket
...
class SIAUDPClient(Thread, BaseSIAClient):
    """Class for Sync SIA UDP Client."""
    ...
    def start(self):
        """Start the SIA UDP Handler thread."""
        _LOGGER.debug("Starting SIA.")
        self.server_thread = Thread(
            target=self.sia_server.serve_forever, name="SIAUDPServerThread"
        )
        self.server_thread.daemon = True
        self.server_thread.start()

    def stop(self):
        """Stop the SIA UDP Handler thread."""
