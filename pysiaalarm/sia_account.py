...
class SIAAccount:
    ...
    def encrypt(self, message: str) -> str:
        ...
        """
        if self.encrypted and message and crypt:
    ...
    def decrypt(self, event: SIAEvent) -> SIAEvent:
        ...
        """
        if self.encrypted and event.encrypted_content and crypt:
    ...
    def create_response(self, event: SIAEvent, response_type: SIAResponseType) -> str:
        ...
        if self.dialect and self.dialect == "jablo":
            crc = int(SIAEvent.crc_calc(res), 16)
            content = f"{header}{res}\r".encode("ascii")
